...
function Home() {
    ...
    document.addEventListener('DOMContentLoaded', function (event) {
        ...
        var dataText = [
             "Swap LXC-USDT token.",
            "Lexeach VDA - Fully decentralised.",
            ...
            {/* <h1 style={{backgroundImage: "url(" + Logo + ")" ,  cursor:'pointer', backgroundRepeat: 'no-repeat' ,  backgroundPosition: 'center', 
                ...
                <div class="container">
                    <div class="banner_text_wthree
                        <div class="d-flex>
                            <h1>Welcome to Lexeach VDA Swap </h1>
                            <h2>swap LXC VDA</h2>                                                  
                        </div>
    ...
    <footer>
        <div class="cpy-right text-center py-4">
            <p class="text-white">This is a decentralized swap application Designed by Lexeach Network | All Right Reserved, Lexeach Network or its Affiliates| 
                <a href="https://lexeach.network/"> .</a>
            </p>
        </div>
    </footer>
        </div>
