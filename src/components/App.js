...
class App extends Component {
  ...
  async loadEthSwapWebSocket(){
    ...
    if (web3Socket){      
      ...
      // if(ethSwapWebSocketData) {
        ...
        // =========== contract address ===========
        const ethSwapWebSocket = await new web3Socket.eth.Contract(EthSwap, "0x7297d49156897b2a514Cf45b3228190d38C9956B")
  ...
  async loadBlockchainData() {
    ...
    // if(tokenData) {
      const token = new web3.eth.Contract(Token, "0x487C09FfecD0525e3D86E55deF2417542cFBDcC6")
      this.setState({ token })
    ...
    // if(ethSwapData) {
      const ethSwap = new web3.eth.Contract(EthSwap, "0x7297d49156897b2a514Cf45b3228190d38C9956B")
      this.setState({ ethSwap })

      const tokenPrice = new web3.eth.Contract(TokenPrice, "0x24108280E6792ca238AeCbB7D1AfD8D34e5a6A20")
